...
var codeValidatorAgent = new ChatCompletionAgent
{
...
var juniorDeveloperAgent = new ChatCompletionAgent
{
...
var seniorDeveloperAgent = new ChatCompletionAgent
{
...
var chat = new AgentGroupChat(codeValidatorAgent, juniorDeveloperAgent, seniorDeveloperAgent)
{
...
var prompt = "I need you to write a function that takes a string as input and returns the number of words in the string.";
